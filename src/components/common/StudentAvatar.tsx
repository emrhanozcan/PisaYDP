...
import { uploadStudentPhoto, removeStudentPhoto } from '@/app/actions/student-photo';
...
interface StudentAvatarProps {
    ...
    showDelete?: boolean;
    table?: 'students' | 'branch_students';
}
...
export default function StudentAvatar({
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const result = await uploadStudentPhoto(studentId, formData, table);
            if (result.success) {
    ...
    const handleDelete = async (e: React.MouseEvent) => {
        ...
        setIsUploading(true);
        try {
            const result = await removeStudentPhoto(studentId, table);
            if (result.success) {
                router.refresh();
            } else {
