    ...
    if (!assignment) {
        return (
            <div style={{
                ...
                <AlertCircle size={64} style={{ marginBottom: '1rem', opacity: 0.3 }} />
                <h2 style={{ fontSize: '1.5rem', color: '#374151', marginBottom: '0.5rem' }}>Erişim Reddedildi</h2>
                <p style={{ marginBottom: '1.5rem' }}>Bu öğrenci sizin listenizde bulunmuyor.</p>
                <Link href="/mentor" className="btn btn-primary">
                    <ArrowLeft size={16} /> Geri Dön
                </Link>
            </div>
