...
import {
    ...
    Award, CheckCircle2, Star, Calendar, ChevronRight, Filter
} from "lucide-react";
...
export default function AdminMentorsClient({ mentors, assignments, serviceLogs }: AdminMentorsClientProps) {
            ...
            <div className="glass-panel" style={{ padding: '1.5rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))', gap: '1.25rem' }}>
                    {filteredMentors.map((mentor, index) => {
                        const isTopPerformer = index === 0 && mentor.totalServices > 0 && searchTerm === '';
                        return (
                            <div
                                key={mentor.id}
                ...
                {filteredMentors.length === 0 && (
                    <div style={{ textAlign: 'center', padding: '4rem', color: '#B2B3BD' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <div>
                                <p style={{ fontWeight: 500, marginBottom: '0.5rem' }}>Aramanızla eşleşen mentör bulunamadı</p>
                ...
                {mentorPerformance.length > 0 && (
                    <div style={{
                        ...
                        <p>Toplam {mentorPerformance.length} mentörden {filteredMentors.length} tanesi gösteriliyor</p>
                    </div>
                )}
            </div>
        </div>
