...
import { Search, Check, X, FileText, Info, Shield, Key, Award, AlertCircle, Edit2, User, Calendar, Building2, GraduationCap, ChevronLeft, ChevronRight } from 'lucide-react';
