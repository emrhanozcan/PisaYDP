...
import { Search, Plus, Edit2, Trash2, Mail, Phone, Download, Upload, X, Save, CheckCircle, Clock, XCircle, MapPin, GraduationCap, CreditCard, FileText, Users } from 'lucide-react';
        ...
        <div style={{ display: 'flex', height: 'calc(100vh - 140px)', gap: '1.5rem' }}>
            ...
            <div style={{ width: '350px', background: 'white', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column', overflow: 'hidden', flexShrink: 0 }}>
                <div style={{ padding: '1rem', borderBottom: '1px solid #f0f0f5' }}>
                    ...
                    <select value={uniFilter} onChange={(e) => setUniFilter(e.target.value)} style={{ width: '100%', padding: '8px', border: '1px solid #e8e8ef', borderRadius: '8px', fontSize: '0.8rem', background: '#fafafc', cursor: 'pointer' }}>
